 ...
 */
interface Main extends \Erebot\Interfaces\Config\Proxy
{
     ...
     *      Erebot::Interfaces::Config::Main::LOAD_FROM_STRING, depending on
     ...
     *
     * \retval array
     *      A list of network configurations, as objects
     *      implementing Erebot::Interfaces::Config::Network.
     */
     ...
     *      loaded using Erebot::Interfaces::Config::Main::LOAD_FROM_STRING.
     */
     ...
     *
     * \retval bool
     *      \b true if the bot must turn into a daemon,
     *      \b false otherwise.
     *
     * \note
     ...
     *
     * \retval string
     *      The group name or GID the bot must switch to, or \b null
     ...
     *
     * \retval string
     *      The user name or GID the bot must switch to, or \b null
     ...
     *      or \b null if its PID should not be written anywhere.
     *
     * \note
