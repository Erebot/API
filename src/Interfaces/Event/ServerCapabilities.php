 ...
 *      (Erebot::Module::ServerCapabilities) for such an event
 *      to be produced.
 */
interface ServerCapabilities extends \Erebot\Interfaces\Event\Base\Generic
{
    /**
     * Returns the module associated with this event.
     *
     * \retval Erebot::Module::ServerCapabilities
