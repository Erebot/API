 ...
 */
interface Erebot_Interface_HelpEnabled
{
    /**
     ...
     *      by this method (TRUE) or not (FALSE). Unhandled help requests
     *      are passed to the next help method registered until either
     *      some help method handles the request or all methods have been
     *      tried with no success. If omitted, FALSE is assumed.
     */
